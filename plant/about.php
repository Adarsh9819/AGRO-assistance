      ...
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-12 col-md-6 mt-4">
            <h3>KISAAN DOST</h3>
            <p>
              Kisaan Dost(agro assistance) is an AI powered completely remote plant monitoring
              and control system. At the core of system is an Nodemcu
              fueled by an ESP32 microcontroller capable of managing 30
              sensors while on board.
            </p>
            <p>
              KISAAN DOST uses ESP32 board for remote connectivity, the DHT11
              temperature and humidity sensor, a resistive soil moisture sensor
              and certain acctuators responsible for operations needed to be performed 
              on the basis of sensor output and predifined conditions 
            </p>
            <p>
              KISAAN DOST tracks the Temperature, Humidity, Soil Moisture 
              for upto four different plants and will
              autonomously water individual plants and will try to maintain temperature and humidity 
              level suitable to plants based upon the AI reports.
            </p>
          </div>
        </div>
          ...
          <div class="col-lg-6">
            <div class="row mt-5">
              ...
              <div class="col-12 col-sm-8">
                <h4>ESP32 Wifi Board</h4>
                <p>
                    The ESP32 is a low-cost Wi-Fi and bluetooth microchip, with a full TCP/IP
          ...
          <div class="col-lg-6">
            <div class="row mt-5">
              ...
              <div class="col-12 col-sm-8">
                <h4>DHT11 Sensor</h4>
                <p>
                    The DHT11 is a digital temperature and humidity sensor. It
                    uses a capacitive humidity sensor and a thermistor to measure
                    the surrounding air
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="row mt-5">
              ...
              <div class="col-12 col-sm-8">
                ...
                <p>
                    The soil moisture sensor consists of two probes that act as
                    variable resistors which are used to measure the volumetric
                    content of water.
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="row mt-5">
              ...
              <div class="col-12 col-sm-8">
                <h4>LCD Screen</h4>
                <p>
                    This is a general LCD display Module, IPS screen, 0.96inch
                    diagonal, 160x80 HD resolution, with embedded controller,
            ...
            <div class="row mt-5">
              ...
              <div class="col-12 col-sm-8">
                ...
                <p>
                  ...
                  changes with the light intensity that falls on the component's
                  sensitive surface
                </p>
              </div>
            </div>
          ...
          <div class="col-lg-6">
            <div class="row mt-5">
              ...
              <div class="col-12 col-sm-8">
                <h4>Solar Panel</h4>
                <p>
                  The 5 watt, 12 volt solar panel will provide enough power to
                  charge small batteries up to 7 Ah or 7000 mAh
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="row mt-5">
              ...
              <div class="col-12 col-sm-8">
                <h4>Lipo Battery</h4>
                <p>
                  A 3.7V 1000mAh lithium polymer battery is a rechargeable
                  battery of lithium-ion technology in a pouch format. It is
                  ideal for lighweight devices
                </p>
              </div>
            </div>
          </div>
